...
**Membros do grupo:** *(inserir nomes e números)*  
**Curso / Turma:** Engenharia Informática – ESTG  
**Data / Versão:** Novembro 2025 – v1.0  

---

## 2. Contexto e Motivação
A comunidade académica enfrenta atualmente dificuldades na reserva organizada de salas de estudo e equipamentos institucionais. O processo é fragmentado, dependente de comunicação informal ou deslocações físicas ao serviço responsável, conduzindo a duplicações de reservas, conflitos de horários e tempos de espera desnecessários.

A ausência de um sistema digital unificado compromete a eficiência e a autonomia dos utilizadores, especialmente em períodos de maior afluência (épocas de avaliações, trabalhos de grupo e projetos práticos). O resultado é a utilização ineficiente dos recursos da instituição.

A aplicação **StudySpace** procura resolver este problema fornecendo uma plataforma centralizada, colaborativa e acessível onde estudantes, docentes e funcionários podem reservar salas e equipamentos com transparência, rapidez e fiabilidade.
...
- **RNF1:** Interface simples, intuitiva e responsiva (mobile-first).  
- **RNF2:** Operações básicas devem responder em menos de 2 segundos.  
...
*(As imagens devem ser colocadas no diretório `/docs/mockups/` ou anexadas ao PDF final.)*
...
### **Entrevista 1 — Estudante**
**Problemas reportados:** dificuldade em encontrar salas livres e gerir reservas de grupo.  
**Feedback:**  
- “A consulta em tempo real é essencial.”  
- “Notificações antes de terminar a reserva são muito úteis.”
...
- “Reservas rápidas evitam deslocações ao serviço técnico.”

### **Entrevista 3 — Funcionário**
**Problemas reportados:** devoluções fora de prazo e reservas sobrepostas.  
**Feedback:**  
- “Preciso de um painel para gerir estados e conflitos.”  
- “Ver reservas pendentes facilita muito o trabalho diário.”
...
- **ChatGPT:** apoio na organização e redação dos requisitos.  
- **Figma / Excalidraw:** criação dos mockups e modelo de informação.  
- **GitHub:** controlo de versões e organização do projeto.  
- **Google Forms / conversas informais:** recolha de requisitos reais.

---

**Documento preparado para submissão na Fase 1.**  
